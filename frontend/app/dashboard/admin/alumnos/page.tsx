// ============================================
// ARCHIVO: frontend/src/app/dashboard/admin/alumnos/page.tsx
// ============================================
...
export default function AlumnosPage() {
  ...
  const handleToggleStatus = async (studentId: string, isActive: boolean) => {
    try {
      await userApi.toggleStatus(studentId, !isActive);
      loadStudents();
    } catch (error) {
      ...
      <div className="flex-1">
        <div className="bg-emerald-700 text-white p-6 relative">
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <p className="mt-2">Administra los alumnos de la plataforma</p>
          </div>
        </div>
